...
import { ArrowLeft, Target, Gamepad2, Plane, Globe, User, Minus, Plus } from "lucide-react-native";
  ...
  return (
    <Screen>
      ...
      <ScrollView showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled" contentContainerStyle={styles.scrollContent}>
          ...
          <View style={styles.heroRow}>
            <View style={styles.heroBody}>
              ...
              <Text style={[styles.heroText, { color: theme.colors.textSecondary }]}>
                Pick autopilot for a classic 21-day streak, or manual for custom-length missions.
              </Text>
            </View>
        ...
        <View style={styles.modeRow}>
          <TouchableOpacity
            style={[
              ...
              mode === "autopilot" && { borderColor: theme.colors.cyan[400], backgroundColor: theme.colors.surfaceElevated },
            ]}
          ...
          <TouchableOpacity
            style={[
              styles.modeCard,
              { backgroundColor: theme.colors.surface, borderColor: theme.colors.border },
              mode === "manual" && { borderColor: theme.colors.amber[500], backgroundColor: theme.colors.surfaceElevated },
            ]}
        ...
        {mode === "manual" && (
          <>
            <Text style={[styles.label, { color: theme.colors.textSecondary, fontSize: theme.typography.caption }]}>Mission length</Text>
            <Text style={[styles.fieldHint, { color: theme.colors.textMuted }]}>Total days for this mission (1–365).</Text>
            <View
              style={[
                styles.daysCard,
                {
            ...
            >
              <View style={styles.daysRow}>
                ...
                <TextInput
                  ...
                  onChangeText={(t) => {
                    ...
                    if (!Number.isNaN(n)) setTotalDays(Math.min(365, Math.max(1, n)));
                  }}
              ...
              <Text style={[styles.daysSummary, { color: theme.colors.textSecondary }]}>
                <Text style={{ fontWeight: "800", color: theme.colors.textPrimary }}>{Math.max(1, Math.min(365, totalDays))}</Text> days
              </Text>
            </View>
          </>
        )}
        ...
        <View style={styles.modeRow}>
          <TouchableOpacity
            style={[
              styles.modeCard,
              { backgroundColor: theme.colors.surface, borderColor: theme.colors.border },
              visibility === "solo" && { borderColor: theme.colors.indigo[500], backgroundColor: theme.colors.surfaceElevated },
            ]}
