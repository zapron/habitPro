-- Align tapped cohort memory detail with the participant marker source.
-- Some older group habits can have stale/null habits.challenge_group_id while
-- challenge_members still correctly links the user, challenge, and habit.
