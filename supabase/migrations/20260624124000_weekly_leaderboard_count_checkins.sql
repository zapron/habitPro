-- Count weekly ranks by quantity:
-- - each completed habit/date pair = 25 points
-- - each completed mini mission = 12 points
-- This keeps multiple missions completed on the same day from collapsing into one score.
