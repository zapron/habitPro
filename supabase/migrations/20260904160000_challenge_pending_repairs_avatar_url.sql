-- Adds avatarUrl to rpc_challenge_pending_repairs_v1's inline profile-label
-- JSON (used for the streak-repair voter list) — this one builds its own
-- label object directly rather than going through the shared
-- _hp_profile_label_json helper.
